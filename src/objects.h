...
void unused_animation_debug(s32 arg0, s32 arg1, s32 arg2);
...
void object_map_reset_index(s32 index);
...
void apply_cutscene_position_overrides(s8);
...
s32 update_animated_object_spline(Object *, s32, Object *);
...
void render_boost_effect(Object *);
...
void set_object_update_rate(s32 updateRate);
void scroll_object_texture_uvs(Object *, s32);
void audspat_update_all(Object **, s32, s32);
void restore_cutscene_positions(void);
CheckpointNode *get_racer_spawn_checkpoint(Object *, Object_Racer *);
void obj_update(s32 updateRate);
void apply_object_collision_response(Object *, Object *);
void obj_door_number(ObjectModel *, Object *);
s16 calculate_path_segment_index(s32 arg0, s32 arg1, s32 arg2, s32 arg3); // NON MATCHING
f32 update_npc_path_movement(Object_NPC *, Object *, f32, f32, s32);
s32 collision_objectmodel(Object *obj, s32 arg1, s32* arg2, Vec3f *arg3, f32* arg4, f32* arg5, s8* surface);
s32 check_model_plane_intersections(ObjectModel *, s32, s32 *, f32 *, f32 *, f32 *, f32 *, f32 *, f32 *, f32 *, s8 *argA,
                  f32); // NON EQUIVALENT
#endif
